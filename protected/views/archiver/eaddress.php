...
<div id="regionContent">
	<div id="regionNav">
		<a href="<?php echo $this->createUrl('/region/regioninfo',array('id'=>0));?>" onclick="eaddress($(this));return false;">现居地</a>
	</div>
	<div id="regionNode">
		<?php echo Region::model()->generateRegionLinks(0, '/region/regioninfo',array('onclick'=>'eaddress($(this));return false;'),false)?>
	</div>
