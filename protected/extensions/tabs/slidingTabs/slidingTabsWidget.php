<?php
class slidingTabsWidget extends CWidget
{
	...
	public $baseUrl;
	public $Jscripts = array('slidingtabs.jquery.js');
	public $Cssscript = 'slidingtabs.css';
...
//		Yii::app()->getClientScript()->registerScript(get_class($this),"$('#{}').uploadify(".CJavaScript::encode($this->_options).");"
