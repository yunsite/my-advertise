...
class uploadifyWidget extends CWidget
{
	...
	public $baseUrl;
	public $Jscripts = array('swfobject.js','jquery.uploadify.v2.1.4.min.js');
	public $Cssscript = 'uploadify.css';
	...
	public $buttonText = 'Select a file';
...
//            'fileDataName'=>$this->hasModel() ? get_class($this->model)."[{$this->attribute}]" : $this->getInputName(),
        ...
        $this->_options['scriptData']['pid'] = $this->pid;
    }
