...
class JobController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','jobinfo','expertise'),
				'users'=>array('@'),
			),
	...
	{
		echo Job::model()->generateJobLinks($id, '/job/jobinfo',array('onclick'=>'eaddress($(this));return false;'));
	}
	...
	{
		$model = Advertisement::model()->findAll(array(
			'join'=>'{{profile}}'
		));
