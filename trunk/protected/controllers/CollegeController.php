...
class CollegeController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','collegeinfo','createcollege'),
				'users'=>array('@'),
			),
	...
	public function actionCollegeInfo()
	{
		...
		$model = College::model()->getColleges($type,$pid);
		
//		UtilHelper::dump($model);
		
		if (isset($type) && isset($pid))
		{
			echo College::model()->generateCollegeLinks($type, $pid,'',array('onclick'=>'eaddress($(this));return false;'));
		}
	}
