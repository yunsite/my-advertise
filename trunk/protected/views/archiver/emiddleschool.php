...
<div id="regionContent">
	<div id="regionNav">
		<a href="<?php echo $this->createUrl('/archiver/emiddleschool');?>" onclick="$('#cmiddleschool').trigger('click');return false;">中学</a>
	</div>
	<div id="regionNode">
...
<input type="hidden" id="schoolType" value="<?php echo College::COLLEGE_TYPE_MIDDELSCHOOL;?>" />
...
function eaddress(object)
{
	...
	if($("#regionNav>a").size() == 3){
		$("#Profile_middleschool").val($("#regionNav a:eq(2)").attr("id"));

		$("#middleschoolHolder").html($("#regionNav a:eq(2)").text());
	}	
...
//		$("#record").val("yes");
		...
		$.get(object.attr('href'),{'type':'<?php echo College::COLLEGE_TYPE_MIDDELSCHOOL;?>'},function(data){
