...
<h4 class="span-10">个人基本资料<span class="ico ico_pencil"></span><a href="#archiver_ebasic" class="more proedit">修改</a></h4>
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
		...
		array(
			'label'=>'现居地',
			'type'=>'raw',
			'value'=>Profile::model()->getUserHomeAddress($model->user->id)
		)
	),
)); ?>
</section>
