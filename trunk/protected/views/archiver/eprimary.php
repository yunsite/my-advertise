...
<div id="regionContent">
	<div id="regionNav">
		<a href="<?php echo $this->createUrl('/archiver/eprimary');?>" onclick="$('#cprimary').trigger('click');return false;">小学</a>
	</div>
	<div id="regionNode">
...
<input type="hidden" id="schoolType" value="<?php echo College::COLLEGE_TYPE_PRIMARYSCHOOL;?>" />
...
function eaddress(object)
{
	...
	if($("#regionNav>a").size() == 3){
		$("#Profile_primaryschool").val($("#regionNav a:eq(2)").attr("id"));

		$("#primaryHolder").html($("#regionNav a:eq(2)").text());
	}	
...
//		$("#record").val("yes");
		...
		$.get(object.attr('href'),{'type':'<?php echo College::COLLEGE_TYPE_PRIMARYSCHOOL;?>'},function(data){
