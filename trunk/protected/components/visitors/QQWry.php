<?php   
// define('__QQWRY__' , dirname(__FILE__)."/assets/QQWry.Dat");  
define('__QQWRY__', Yii::app()->getBasePath().'/data/QQWry.dat');
// echo __QQWRY__; 
...
class QQWry{ 
    ...
    public $CountryFlag=0; // 标识 Country位置 
...
// 		return $this->Country.$this->Local;
		return mb_convert_encoding($this->Country.$this->Local, 'UTF-8', 'GBK');
	}	
